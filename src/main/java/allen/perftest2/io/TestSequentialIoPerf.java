...
public final class TestSequentialIoPerf {
    ...
    public static final long   FILE_SIZE  = PAGE_SIZE * 1000L * 40L;
    public static final String FILE_NAME  = "test_TestSequentialIoPerf.dat";
    ...
    /**
     * Pre allocate test file with file name and size.
     * */
